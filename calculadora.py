...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora do Gustave')
        self.setFixedSize(400, 400)
        self.cw = QWidget()
        self.cw.setStyleSheet(
            '* {background: #993399; color: #FFF; font-size: 30px;}'
        )
        ...
        self.display.setStyleSheet(
            '* {background: #FFF; color: #FB5E02; font-size: 30px;}'
        )
        ...
        self.add_btn(
            ...
            'background: #F48422; color: #fff; font-weight: 500;'
        )
        ...
        self.add_btn(
            ...
            'background: #F48422; color: #FFF; font-weight: 700'
        )
